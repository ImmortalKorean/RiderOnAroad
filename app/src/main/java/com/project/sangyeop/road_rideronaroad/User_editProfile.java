...
public class User_editProfile extends AppCompatActivity {
    ...
    static final int EDIT_STATUS_MESSAGE = 444;
    static final int EDIT_USER_NICKNAME = 555;
    static final int FACE_DETECT = 666;
...
//    String imgfolderName;
    ...
    ImageView logged_user_profileImg, logged_user_backgroundImg;
    ...
    TextView edit_logged_user_nickName, current_statusMessage, logged_user_statusMsg_on_editProfile;

    int imageLocation;
    String logged_userNickname;
    String logged_user_statusMessage;

    RelativeLayout edit_statusMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_logged_user_nickName = (TextView) findViewById(R.id.edit_logged_user_nickName);
        current_statusMessage = (TextView) findViewById(R.id.current_statusMessage);
        logged_user_statusMsg_on_editProfile = (TextView) findViewById(R.id.logged_user_statusMsg_on_editProfile);
        edit_statusMessage = (RelativeLayout) findViewById(R.id.edit_statusMessage);

        edit_logged_user_nickName.setText(logged_userNickname);
...
//                .into(logged_user_profileImg);
        ...
        edit_logged_user_nickName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent editStatusMsg_and_Nickname = new Intent(User_editProfile.this, User_editStatusMsg_and_Nickname.class);

                editStatusMsg_and_Nickname.putExtra("current_selection_function_character_limit", "20");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_name", "사용자 별명 수정");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_title", "사용자 별명");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_content", edit_logged_user_nickName.getText().toString());

                startActivityForResult(editStatusMsg_and_Nickname, EDIT_USER_NICKNAME);
            }
        });

        edit_statusMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent editStatusMsg_and_Nickname = new Intent(User_editProfile.this, User_editStatusMsg_and_Nickname.class);

                editStatusMsg_and_Nickname.putExtra("current_selection_function_character_limit", "60");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_name", "상태 메시지 수정");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_title", "상태 메시지");
                editStatusMsg_and_Nickname.putExtra("current_selection_function_content", current_statusMessage.getText().toString());

                startActivityForResult(editStatusMsg_and_Nickname, EDIT_STATUS_MESSAGE);
    ...
    private void Dialog_getImage() {
        ...
        fromImage.setNegativeButton("사진촬영", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Intent intent = new Intent(User_editProfile.this, faceDetect.class);
                startActivityForResult(intent, FACE_DETECT);
...
//                startActivityForResult(intent, PICK_FROM_CAMERA);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case EDIT_USER_NICKNAME:

                if (resultCode == RESULT_OK) {

                    edit_logged_user_nickName.setText(userInfo_sharedPreferences.getString("user_nickname", "null"));
                    Log.d("유저닉네임 갱신완료 : ", userInfo_sharedPreferences.getString("user_nickname", "null"));
                }
            ...
            case EDIT_STATUS_MESSAGE:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    current_statusMessage.setText(userInfo_sharedPreferences.getString("status_message", "null"));
                    logged_user_statusMsg_on_editProfile.setText(userInfo_sharedPreferences.getString("status_message", "null"));
                    Log.d("유저닉대화명 갱신완료 : ", userInfo_sharedPreferences.getString("status_message", "null"));
...
//                    Bitmap bitmap = (Bitmap)data.getExtras().get("faceImg");
//                    logged_user_profileImg.setImageBitmap(bitmap);
                }
                break;
...
//                    File f2 = new File(filepath);
                    ...
                    if (extras != null) {
                        ...
                        if (imageLocation == 1) {
                            ...
                            SharedPreferences sharedPreferences = getSharedPreferences("user_info", 0);
                            String encodedString = sharedPreferences.getString("user_img", null);
                            Log.d("내부 db가 필요하다..", encodedString);
                            try {
                                byte[] encodeByte = Base64.decode(encodedString, Base64.DEFAULT);
                                Bitmap bitmap = BitmapFactory.decodeByteArray(encodeByte, 0, encodeByte.length);
                                logged_user_profileImg.setImageBitmap(bitmap);
...
//                    upLoadServerUri = "http://yeop0715.cafe24.com/uploadImg_to_server.php";
                    ...
                    dialog = ProgressDialog.show(User_editProfile.this, "", "Uploading file...", true);
...
//                        messageText.setText("MalformedURLException Exception : check script url.");
                        Toast.makeText(User_editProfile.this, "MalformedURLException",
...
//                        messageText.setText("Got Exception : see logcat ");
    ...
    public void onResume() {
        ...
        edit_logged_user_nickName.setText(logged_userNickname);
        current_statusMessage.setText(logged_user_statusMessage);
        logged_user_statusMsg_on_editProfile.setText(logged_user_statusMessage);
