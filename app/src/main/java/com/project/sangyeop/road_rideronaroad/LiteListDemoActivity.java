...
public class LiteListDemoActivity extends AppCompatActivity {
    ...
    private static void setMapLocation(GoogleMap map, NamedLocation data) {
        ...
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(data.location, 17f));
        ...
        rectOptions.add(new LatLng(37.1, 127.1));
        rectOptions.add(new LatLng(38.1, 128.1));
        rectOptions.add(new LatLng(39.1, 129.1));
        rectOptions.add(new LatLng(49.1, 129.1));
        rectOptions.add(data.location);

        map.addPolyline(rectOptions);

        start = new LatLng(37.1, 127.1);
        end = data.location;

        LatLngBounds.Builder builder = new LatLngBounds.Builder();
        builder.include(start).include(data.location);
