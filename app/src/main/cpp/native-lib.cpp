...
JNICALL
Java_com_project_sangyeop_road_1rideronaroad_faceDetect_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_project_sangyeop_road_1rideronaroad_faceDetect_loadCascade(JNIEnv *env, jclass type,
...
Java_com_project_sangyeop_road_1rideronaroad_faceDetect_detect(JNIEnv *env, jclass type,
